...
import br.com.smartclinmed.web.dto.EstadoDTO;
import br.com.smartclinmed.web.services.EstadoService;
...
public class EstadoResource {
	...
	public ResponseEntity<Page<EstadoDTO>> findPage(@RequestParam(value = "page", defaultValue = "0") Integer page,
	...
	public ResponseEntity<Void> update(@Valid @RequestBody Estado obj, @PathVariable Long id) {
		//Estado obj = service.fromDto(objDto);
		obj.setId(id);
